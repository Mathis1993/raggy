...
SECRET_KEY = "django-insecure-+rpsn5x81y%)aa%t^$7)uhual@k^x&d&zi-ax0hf(qnda%&lv+"
...
# REDIS
# TODO: add this to production settings
# CACHES = {
#     "default": {
...
# EMAIL
FROM_EMAIL = os.getenv("FROM_EMAIL", "noreply@localhost.de")
