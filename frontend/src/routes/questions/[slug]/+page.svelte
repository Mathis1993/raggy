<script lang="ts">
    import {ActivityItem, Breadcrumb, BreadcrumbItem, Card, TimelineItem} from "flowbite-svelte";
...
<Card class="max-w-full">
    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> Your Recent Question</h5>
